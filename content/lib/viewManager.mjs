...
var {getgBrowser, iter, items, iterTabs, isPrivateTabOpen, isTabPrivate, getBaseDomainFromHost} = ChromeUtils.importESModule("chrome://zoomlevel/content/lib/utils.mjs");
