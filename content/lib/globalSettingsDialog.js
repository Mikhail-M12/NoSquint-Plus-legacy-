...
GlobalSettingsDialog.prototype = {
    ...
    open: function () {
        ...
        this.tab = gBrowser.addTab("chrome://zoomlevel/content/lib/globalSettings.xhtml",{relatedToCurrent: true});
    ...
    save: function (settings) {
        for (let [id, val] in items(settings)) {
...
function onLoad() {
    ...
    for (let [id, defcolor] in items(prefController.defaultColors)) {
