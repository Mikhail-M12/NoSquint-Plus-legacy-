...
var {prefController} = ChromeUtils.importESModule("chrome://zoomlevel/content/lib/viewManager.mjs");

var {getgBrowser, items} = ChromeUtils.importESModule("chrome://zoomlevel/content/lib/utils.mjs");
...
function onLoad() {
	...
	this.tabBrowser.messageManager.sendAsyncMessage("zoomlevel-globalSettings-linux", {});
}